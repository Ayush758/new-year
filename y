...
try:
    ...
    url_vyos_1x = os.getenv('VYOS1X_REPO_URL', default='https://github.com/Ayush758/new-year')
...
if __name__ == "__main__":
    ...
    if build_config["reuse_iso"]:
        ...
        os_release = f"""PRETTY_NAME="mct {version} ({build_config['release_train']})"
NAME="mct"
VERSION_ID="{version}"
...
"""
        ...
        iso_file = f"mct-{version_data['version']}-{build_config['build_flavor']}-{build_config['architecture']}.iso"
        ...
        lb config noauto \
                ...
                --bootappend-live "boot=live components hostname=mct username=live nopersistence noautologin nonetworking union=overlay console=ttyS0,115200 console=tty0 net.ifnames=0 biosdevname=0" \
